...
RSpec.describe "/federal_tax_brackets", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      FederalTaxBracket.create! valid_attributes
      get federal_tax_brackets_url
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get federal_tax_bracket_url(federal_tax_bracket)
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /new" do
    it "renders a successful response" do
      get new_federal_tax_bracket_url
      expect(response).to be_successful
    end
  end
  ...
  describe "GET /edit" do
    it "renders a successful response" do
      federal_tax_bracket = FederalTaxBracket.create! valid_attributes
      get edit_federal_tax_bracket_url(federal_tax_bracket)
      expect(response).to be_successful
    end
  end
  ...
  describe "DELETE /destroy" do
    it "destroys the requested federal_tax_bracket" do
      federal_tax_bracket = FederalTaxBracket.create! valid_attributes
      expect {
        delete federal_tax_bracket_url(federal_tax_bracket)
      }.to change(FederalTaxBracket, :count).by(-1)
    end

    it "redirects to the federal_tax_brackets list" do
      federal_tax_bracket = FederalTaxBracket.create! valid_attributes
      delete federal_tax_bracket_url(federal_tax_bracket)
      expect(response).to redirect_to(federal_tax_brackets_url)
    end
  end
end
